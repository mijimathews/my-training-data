...
**Last successful sync:** 2026-05-04 16:19:13 UTC
...
|------|-------------|------|
| `latest.json` | Current 7-day snapshot + derived metrics | [View](https://raw.githubusercontent.com/mijimathews/my-training-data/main/latest.json) |
| `history.json` | Longitudinal data (daily/weekly/monthly) | [View](https://raw.githubusercontent.com/mijimathews/my-training-data/main/history.json) |
...
- Current: https://raw.githubusercontent.com/mijimathews/my-training-data/main/latest.json
